    ...
    return (
      <Layout>
        ...
        <section className="text-white p-8">
          <h1 className="text-3xl font-bold">Our Wedding</h1>
          <p className="mt-4">Will contain more information about the wedding venue, attire, food, other rules, and so forth. Coming soon!</p>
        </section>
      </Layout>
    );
  }