      ...
      <Layout>
        ...
        <section className="text-white p-8">
          <div className="flex flex-col text-white font-habibi justify-between h-full">
              ...
              <p class="leading-loose ml-5 text-xs md:text-base lg:text-lg">
                The church will have parking reserved in the front of the church and at the Kaimuki Public Library across the street (Harding Avenue). For the reception, there will also be parking in the structure across from the venue. Further details will be provided later.
              </p>
